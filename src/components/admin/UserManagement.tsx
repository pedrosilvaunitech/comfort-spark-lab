        ...
        <CardContent>
          <form onSubmit={handleCreateUser} className="space-y-4">
            <div>
              ...
              <Input value={newName} onChange={(e) => setNewName(e.target.value)} placeholder="João da Silva" required />
            </div>
            <div>
              <Label>Email</Label>
              <Input type="email" value={newEmail} onChange={(e) => setNewEmail(e.target.value)} placeholder="joao@clinica.com" required />
            </div>
            <div>
              <Label>Senha</Label>
