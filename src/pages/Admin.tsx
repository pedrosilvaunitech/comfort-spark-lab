              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div><Label>Fonte de Impressão</Label><Select value={printerConfig.printFont || "monospace"} onValueChange={(v: any) => setPrinterConfig({ ...printerConfig, printFont: v })}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="monospace">Monospace (padrão)</SelectItem><SelectItem value="sans-serif">Sans-serif (Arial)</SelectItem><SelectItem value="serif">Serif (Georgia)</SelectItem></SelectContent></Select></div>
                    <div className="flex items-center justify-between"><Label>Rotacionar 180° (impressão invertida)</Label><Switch checked={printerConfig.rotate180 || false} onCheckedChange={(v) => setPrinterConfig({ ...printerConfig, rotate180: v })} /></div>
