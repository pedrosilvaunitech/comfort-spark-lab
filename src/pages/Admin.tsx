...
const NAV_ITEMS: NavItem[] = [
  ...
  { id: "printer", label: "Impressora", icon: <Printer className="h-4 w-4" />, adminOnly: true },
  { id: "layout", label: "Layout do Ticket", icon: <LayoutTemplate className="h-4 w-4" />, adminOnly: true },
